...
/**
 * REST controller for managing {@link com.example.microservices.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
public class ProductOrderResource {
    ...
    private static final String ENTITY_NAME = "microbProductOrder";
    ...
    public ResponseEntity<ProductOrderDTO> updateProductOrder(@Valid @RequestBody ProductOrderDTO productOrderDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productOrderDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ProductOrderDTO> getProductOrder(@PathVariable String id) {
